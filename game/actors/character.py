class character():
    ...
    def __init__(self, name, classfunction, action, inventorySpace, life, strength, intelligence):
        self.name = name
    ...
    def getStatus(self):
        return self.name, self.classFunction, self.action, self.inventorySpace, self.life, self.strength, self.intelligence
